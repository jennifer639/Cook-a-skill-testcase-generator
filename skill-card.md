...
| **Tools / AI Used** | **Claude** (Anthropic) — build skill, write instructions, test & iterate <br> **ChatGPT** — research <br> **ChatGPT Codex** (OpenAI) — refine instructions, generate sample test case examples |
